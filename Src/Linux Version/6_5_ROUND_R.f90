    ...
    Temp1 = (one/3.0_p2 + 5.0_p2/6.0_p2*faiR_bar)*omega_0 +&
        two*faiR_bar*(one-omega_0)
    Temp2 = two*faiR_bar
    Temp3 = (one/3.0_p2 + 5.0_p2/6.0_p2*faiR_bar)*omega_1 +&
        (lambda_1*faiR_bar-lambda_1+one)*(one-omega_1)
